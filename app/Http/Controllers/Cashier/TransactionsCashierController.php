...
class TransactionsCashierController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('cashier.transactions.index', ['transactions' => $transactions]);
    }
    ...
    public function edit(Transactions $transactions, $id)
    {
        ...
        return view('cashier.transactions.edit', ['trans' => $trans, 'transDetails' => $transDetails]);
    }
