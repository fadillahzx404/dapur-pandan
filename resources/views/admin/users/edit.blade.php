    ...
    <div class="container px-12 lg:mt-10 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <section class="product-edit card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                ...
                <form action="{{ route('users-admin.update', $user->id) }}" method="POST" class="grid gap-3"
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex items-center justify-center w-full mt-3">
                                    ...
                                    <label for="imgInp"
                                        ...
                                        <input id="imgInp" type="file" class="hidden" name="photo_profile" />
                                    </label>
                                </div>
                            </div>
                            <div class="flex flex-col">
                                ...
                                <div class="w-full h-full grid">
                                    ...
                                    <img src=""
                                        class="result-foto w-48 h-48 rounded-full border border-gray-300 shadow-lg place-self-center object-center object-contain"
                                        id="resultfoto" alt="">
                    ...
                    <div class="form-control">
                        ...
                        <select id="countries" name="roles"
                            class="select select-accent w-full  focus:outline-offset-0 focus:border-accent">

                            <option value="ADMIN" @if ($user->roles == 'ADMIN') selected @endif>ADMIN</option>
                            <option value="CASHIER" @if ($user->roles == 'USER') selected @endif>USER</option>
                    ...
                    <div class="form-control">
                        ...
                        <div class="relative">
                            ...
                            <button id="btn-eye" type="button"
                                class="btn btn-ghost hover:bg-accent absolute right-0 text-gray-800 hover:text-white">
                        ...
                        <label for="">
                            <span class="label-text text-red-600">*Password sebelumnya tidak bisa dilihat, jagan dimasukan
                                jika
                                tidak ingin di ubah.</span>
                        </label>
                    </div>
