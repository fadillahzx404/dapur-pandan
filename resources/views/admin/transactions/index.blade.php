...
@section('page-content')
    <div class="container px-12 lg:mt-8 max-lg:px-10 max-sm:px-5 mx-auto min-h-screen">
        ...
        <p class="text-3xl font-semibold mt-8 mb-6">All Transactions</p>
            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        <p class="text-lg font-bold">Transactions</p>
                        <p class="text-sm font-light text-gray-400">All Product on here, you can add new transactions, edit
                            or
                            delete.
                        </p>
                    </div>
                    ...
                    @foreach ($transactions as $trans)
                        <tr class="border-2 ">
                            ...
                            <td class="py-4 text-center ">
                                <span
                                    class="badge @if ($trans->transaction_status == 'Unpaid') badge-warning @elseif ($trans->transaction_status == 'Paid') badge-info @elseif ($trans->transaction_status == 'Process') badge-primary @elseif ($trans->transaction_status == 'Paid') badge-info @elseif ($trans->transaction_status == 'Fail') badge-error @elseif ($trans->transaction_status == 'Success') badge-accent @endif">
                            ...
                            <td class="w-52 py-4 text-center">
                                ...
                                <div class="dropdown dropdown-end ">
                                    ...
                                    <ul tabindex="0"
                                        ...
                                        <li class=""><a href="{{ route('transactions.edit', $trans->id) }}"
