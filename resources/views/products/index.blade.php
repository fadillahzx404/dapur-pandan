                                ...
                                <li class="splide__slide">
                                    <a href="{{ route('detail_product', $lat->id) }}" class="p-3">
                                        <div
                                            ...
                                            <figure
                                                class="bg-cover bg-center max-w-xs  [@media(min-width:1280px)]:h-[160px] [@media(min-width:1024px)]:min-w-[350px]  [@media(width:768px)]:max-h-28 max-sm:h-[100px] border-b">
